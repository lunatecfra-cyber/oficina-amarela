...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    ...
    texto: "Agora você recebe e-mail quando um editor pega sua missão, quando o vídeo fica pronto, quando aprovam sua entrega e quando pedem um ajuste. Antes só dava pra saber abrindo o site.",
  },
  {
    date: "2026-08-15",
    ...
    texto: "O porta-voz não precisa mais esperar o controle de qualidade: assiste, dá a nota e fecha a missão na hora. O inspetor continua podendo aprovar quando for preciso.",
  },
  {
    date: "2026-08-14",
    ...
    texto: "Porta-voz, editor e inspetor conversam na própria missão — sem sair pro WhatsApp e sem perder o contexto do que foi combinado.",
  },
  {
    date: "2026-08-13",
    ...
    texto: "Dá pra criar conta e entrar direto pela conta Google. Quem esqueceu a senha também volta por aí, sem depender de e-mail de recuperação.",
  },
  {
    date: "2026-08-12",
    ...
    texto: "As missões chegam uma por vez pra quem está online, em vez de uma lista onde todo mundo disputa. Aceitou, é sua; passou, vai pro próximo.",
  },
];
