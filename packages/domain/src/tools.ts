 ...
 * não escolheu fica com `status: "coming_soon"` e aparece na tela como espaço
 * reservado — nunca com um link inventado, que só faz a pessoa perder tempo
 * clicando. Quem for preencher mexe só aqui.
 *
 * Os links abaixo vieram da lista que já estava na página de ferramentas.
 */
...
export type Tool = {
  ...
  what: string;
  /** endereço real; ausente quando `status` é "coming_soon" */
  url?: string;
  status?: ToolStatus;
  /**
...
export type ToolGroupId = "music" | "audio" | "editing" | "creation";
