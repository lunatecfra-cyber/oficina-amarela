...
export function WhatsappField({
  ...
  const incompleto = value.length > 0 && !isCompleteWhatsapp(value);
    ...
    <div>
      ...
      <p id="whatsapp-ajuda" className="mt-1.5 text-xs leading-relaxed text-muted-2">
        {incompleto
          ...
          : (hint ??
            "Com DDD. Fica visível pra quem estiver na mesma missão que você.")}
      </p>
    </div>
  );
}

export { WhatsappField as CampoWhatsapp };
