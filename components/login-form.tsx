  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <p className="mt-6 text-center text-sm text-muted">
        Ainda não é membro?{" "}
        <Link href="/criar-conta" className="inline-flex min-h-11 items-center px-2 font-medium text-gold-hi hover:underline">
          Crie uma conta
        </Link>
      </p>
      ...
      <p className="mt-4 text-center text-xs text-muted-2">
        ...
        <Link href="/termos" className="inline-flex min-h-11 items-center text-muted hover:text-silver-hi hover:underline">
          Termos de Uso
        </Link>{" "}
        e a{" "}
        <Link href="/privacidade" className="inline-flex min-h-11 items-center text-muted hover:text-silver-hi hover:underline">
