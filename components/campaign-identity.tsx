...
export function CampaignIdentity({
  ...
  function desenhar(ctx: CanvasRenderingContext2D) {
    ...
    const linhas = [
      ...
      { texto: valores.officialName.toUpperCase(), tamanho: 56, cor: "#ffffff", peso: "bold", espaco: 86 },
      { texto: `Nº ${valores.candidateNumber}`, tamanho: 48, cor: "#f4ce1f", peso: "bold", espaco: 72 },
      { texto: `CNPJ ${valores.campaignTaxId}`, tamanho: 36, cor: "#e6e6ea", peso: "normal", espaco: 0 },
    ];
...
export { CampaignIdentity as IdentificacaoCampanha };
