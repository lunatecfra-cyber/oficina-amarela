  ...
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-5xl items-center gap-8 lg:grid-cols-[1fr_1.05fr] lg:gap-16">
        ...
        <div className="relative mx-auto h-[28rem] w-full max-w-lg" aria-label="Premiação: primeiro lugar ganha ingresso; segundo e terceiro ganham presentes misteriosos">
          ...
          <div className="ingresso-palco">
            <div className="premio-ingresso">
              ...
              <span className="premio-ingresso__dados">
                <span><b>Entrada</b>Inteira</span>
                <span><b>Setor</b>Pista</span>
              </span>
