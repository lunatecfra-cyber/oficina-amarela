          ...
          <section className="reveal overflow-hidden rounded-2xl border border-line bg-surface/60">
            ...
            <div className="px-5 pb-6 lg:px-8">
              <div className="relative z-10 -mt-12 flex items-end justify-between gap-4 lg:-mt-14">
                ...
                <Link href="/profile/edit" className="btn-ghost mb-1 w-auto px-4 text-sm">
                  Editar perfil
                </Link>
              </div>
              ...
              <Card title="Sobre" delay={0.05}>
                {p.bio ? (
                  ...
                  <p className="text-sm text-muted-2">
                    ...
                    <Link href="/profile/edit" className="text-gold-hi hover:underline">
                      Escrever agora
                    </Link>
                  </p>
                )}
            ...
            <aside className="flex flex-col gap-6">
              ...
              <Card title="Disponibilidade" delay={0.2}>
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <Link href="/schedule" className="text-xs text-muted transition-colors hover:text-gold-hi">
                    Editar →
                  </Link>
                </div>
                <MiniGrid grid={grid} />
