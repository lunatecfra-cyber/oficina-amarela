import { GUILD_DRIVE } from "@oficina/domain/tools";
    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto w-full max-w-3xl px-5 py-6 lg:px-8 lg:py-10">
          ...
          <p className="mt-1 text-sm text-muted">O que abrir quando trava no meio de um corte.</p>
          ...
          <section className="mt-10 rounded-2xl border border-gold-lo/40 bg-gold/[0.05] p-5">
            ...
            <p className="mt-1 text-sm leading-relaxed text-muted">
              A pasta com o que já foi separado aqui dentro: trilhas, efeitos e material de apoio.
            </p>
            <a
              href={GUILD_DRIVE}
              target="_blank"
            ...
            <p className="mt-3 text-xs leading-relaxed text-muted-2">
              As pastas separadas de músicas, áudios e referências ainda estão por montar — quando
              existirem, entram na lista acima.
            </p>
          </section>
        </div>
      </main>
