  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center px-6 py-14">
      ...
      <p className="mb-7 max-w-sm text-center text-sm text-muted">
        Se a sua conta usa um e-mail do Google, o caminho mais rápido é entrar direto por ele — o
        Google confirma que o e-mail é seu e você entra na mesma conta de sempre.
      </p>
      ...
      <div className="mb-6 flex w-full max-w-sm items-center gap-3">
        ...
        <span className="text-[11px] uppercase tracking-[0.14em] text-muted-2">ou pelo e-mail</span>
        <span className="h-px flex-1 bg-line" />
      </div>
