...
const TARGET_AUDIENCE = [
  {
    ...
    items: [
      "Grava e manda o link do Drive",
      "Diz o tom, a cor e o formato",
      "Assiste, aprova ou pede ajuste",
    ],
    icon: (
  ...
  },
  {
    ...
    items: [
      "Recebe missão sem disputar",
      "Uma por vez, sem acúmulo",
      "Nota e reputação a cada entrega",
    ],
    icon: (
      <>
    ...
    <main className="flex-1">
      <section className="relative overflow-hidden px-6 pt-12 lg:pt-16">
        ...
        <div className="relative mx-auto w-full max-w-5xl">
          ...
          >
            A guilda de quem edita. Porta-vozes mandam o bruto, editores recebem uma missão por vez
            e todo mundo evolui junto.
          </p>
          ...
          >
            ...
            <Link href="/login" className="tap-target text-sm text-muted">
              Já sou membro
            </Link>
          </div>
        </div>
        ...
        <div className="mx-auto w-full max-w-5xl">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted lg:text-base">
              Duas pessoas, dois ritmos e um mesmo vídeo. A produção começa no celular e termina com
              uma entrega que dá gosto de publicar.
            </p>
          </div>
                ...
                <ol className="relative flex flex-col gap-5 pl-9">
                  ...
                  {track.steps.map((p, i) => (
                    <li key={p.t} className="group relative">
                      ...
                      <h3 className="font-medium text-text transition-colors group-hover:text-gold-hi">
                        {p.t}
                      </h3>
          ...
          <p className="mx-auto mt-10 max-w-xl text-center text-xs leading-relaxed text-muted-2">
            O vídeo fica no Google Drive de quem gravou, do começo ao fim. A Oficina Amarela não
            guarda arquivo de ninguém.
          </p>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden border-t border-line-soft px-6 py-16 lg:py-20">
        ...
        <div className="relative mx-auto w-full max-w-2xl text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-muted">
            Criar conta leva menos de um minuto. Dá pra entrar com o Google ou com apelido e senha.
          </p>

          <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/criar-conta"
              className="btn-gold sm:w-52 text-center flex items-center justify-center"
            >
              Criar minha conta
            </Link>
            <Link
              href="/login"
              className="btn-ghost sm:w-40 text-center flex items-center justify-center"
            >
              Fazer login
            </Link>
          </div>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-1 text-xs text-muted-2">
            <Link href="/termos" className="tap-target">
              Termos de uso
            </Link>
            <span aria-hidden="true">·</span>
            <Link href="/privacidade" className="tap-target">
              Política de privacidade
            </Link>
            <span aria-hidden="true">·</span>
            <Link href="/parceiros" className="tap-target">
              Parceiros
            </Link>
          </div>
        </div>
